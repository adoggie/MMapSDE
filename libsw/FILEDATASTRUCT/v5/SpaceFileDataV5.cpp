// SpaceFileDataV5.cpp: implementation of the CSpaceFileDataV5 class.
//
//////////////////////////////////////////////////////////////////////

#include "./stdafx.h"
#include "SpaceFileDataV5.h"

#include "./FileDataStruct/V5/GIS_FeatureRoadSectionV5.h"
#include "./Zlib/zlib.h"

//////////////////////////////////////////////////////////////////////////
char s_DestBuf2[10000000];
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CSpaceFileDataV5::CSpaceFileDataV5()
{
...
BOOL CSpaceFileDataV5::Load(LPCTSTR strFilePath)
{
#ifdef ANALYSE_DATA
...
BOOL CSpaceFileDataV5::Write(LPCTSTR strFileName)
{
	//写文件
	CMemFile aMemFile;
...
//////////////////////////////////////////////////////////////////////////
#ifdef _DEBUG
void CSpaceFileDataV5::DumpState()
{
    TRACE0("********************************************************************\n");
	TRACE0("CSpaceFileDataV5 Info:\n");
...
void CSpaceFileDataV5::AssertValid() const
{
...
BOOL CSpaceFileDataV5::WriteSpaceData(CFile* pFile)
{
	//---------------------------
	//构造头,写头

    StuSpaceFileStructV5::StuHeaderInfo aFileHeadInfo;
    {	
    ...
    StuSpaceFileStructV5::StuIndexInfoOfMap* pIndexInfoOfMap = 
        new StuSpaceFileStructV5::StuIndexInfoOfMap[nCount];
    memset(pIndexInfoOfMap,0,sizeof(StuSpaceFileStructV5::StuIndexInfoOfMap)*nCount);
    
    DWORD IndexPos = pFile->GetPosition();
    pFile->Write(pIndexInfoOfMap,sizeof(StuSpaceFileStructV5::StuIndexInfoOfMap) * nCount);
    //////////////////////////////////////////////////////////////////////////
...
BOOL CSpaceFileDataV5::WriteMap       (
    CFile* pFile,
    StuSpaceFileStructV5::StuIndexInfoOfMap* pIndexInfoOfMap)
{
    ...
    StuSpaceFileStructV5::StuIndexInfoOfBreadth* pIndexInfoOfBreadth 
        = new StuSpaceFileStructV5::StuIndexInfoOfBreadth[nCount];
    memset(pIndexInfoOfBreadth,0,sizeof(StuSpaceFileStructV5::StuIndexInfoOfBreadth)*nCount);

    //////////////////////////////////////////////////////////////////////////
    DWORD dwIndexPos = pFile->GetPosition();
    pFile->Write(pIndexInfoOfBreadth,sizeof(StuSpaceFileStructV5::StuIndexInfoOfBreadth)*nCount);
    //////////////////////////////////////////////////////////////////////////
 ...
 * @return
*/
char s_BuddyBuf[10000000];

BOOL CSpaceFileDataV5::WriteBreadth   (
    CFile* pFile,
    StuSpaceFileStructV5::StuIndexInfoOfBreadth* pBreadthIndex,
    MapOfFeature* pRoadSectionContainer)
{	
    ASSERT(pBreadthIndex);
    StuSpaceFileStructV5::StuBreadthHeaderInfo* pHeader = new StuSpaceFileStructV5::StuBreadthHeaderInfo;
    memset(pHeader,0,sizeof(StuSpaceFileStructV5::StuBreadthHeaderInfo));
    ...
    CMemFile aMemFile;
    {
		...
		pFile->Write(pHeader,		sizeof(StuSpaceFileStructV5::StuBreadthHeaderInfo));
        ...
        {
            pair < unsigned long,CGIS_FeatureRoadSectionV5*> aPair = *iteratorOfRoadSection;
            CGIS_FeatureRoadSectionV5* pFtr = aPair.second;
       
            pFile->Write(pFtr->GetDataAddr(),sizeof(StuSpaceFileStructV5::StuGisFeatureRoadSection));
        }
        //////////////////////////////////////////////////////////////////////////
        //在这里要转换所有Ftr的Buddy数据
        {
            ...
            VERIFY(GetBuddyDataSize(pRoadSectionContainer,StuSpaceFileStructV5::EN_GOTYPE_RUT,nBuddyDataSize));
            ...
            CollectBuddyData(
                pRoadSectionContainer,
                pBuddy,
                StuSpaceFileStructV5::EN_GOTYPE_RUT,
...
*	return value:	index
*/
long CSpaceFileDataV5::Dichotomy(unsigned long* pnArr, int nNumElement, unsigned long nValue)
{
...
long CSpaceFileDataV5::GetIndexByID(unsigned long nID)
{
    return Dichotomy(&m_SortIDArray[0],m_SortIDArray.size(),nID);

}
BOOL CSpaceFileDataV5::GetBuddyDataSize(
     MapOfFeature* pRoadSectionContainer,
     int nType,
     unsigned long& nBuddyDataSize)
{
	...
	switch(nType)
	{
	case StuSpaceFileStructV5::EN_GOTYPE_POINT:
        {
            ASSERT(FALSE);
        }
		break;
	case StuSpaceFileStructV5::EN_GOTYPE_RUT:
        {
            {
                ...
                {
                    pair < unsigned long,CGIS_FeatureRoadSectionV5*> aPair = *iteratorOfFtr;
                    CGIS_FeatureRoadSectionV5* pFtr = aPair.second;
                    ASSERT(pFtr);
		...
		break;
	case StuSpaceFileStructV5::EN_GOTYPE_LINE:
        {
            ASSERT(FALSE);
        }
		break;
	case StuSpaceFileStructV5::EN_GOTYPE_POLY:
        {
            ASSERT(FALSE);
        }
		break;
...
BOOL CSpaceFileDataV5::CollectBuddyData(
     MapOfFeature* pRoadSectionContainer,
     char* pBuddy,
     int nType,
     unsigned long& nCharDataBuddyLength,
...
BOOL CSpaceFileDataV5::ReadSpaceData(CFile* pFile)
{

	//读头
    StuSpaceFileStructV5 :: StuHeaderInfo* pFileHeadInfo = new StuSpaceFileStructV5 :: StuHeaderInfo;
	pFile->Read(pFileHeadInfo,sizeof(StuSpaceFileStructV5 :: StuHeaderInfo));
	...
	//---------------------------
	//读入地图索引
	StuSpaceFileStructV5::StuIndexInfoOfMap* pIndexInfoArray = NULL;		//地图索引信息
	pIndexInfoArray = new StuSpaceFileStructV5::StuIndexInfoOfMap[nCount];
	memset(pIndexInfoArray,0,sizeof(StuSpaceFileStructV5::StuIndexInfoOfMap)*nCount);
	pFile->Read(pIndexInfoArray,sizeof(StuSpaceFileStructV5::StuIndexInfoOfMap) * nCount);
	...
	for(int i = 0; i < nCount; i++)
	{
        ...
        pItem->pIndex = new StuSpaceFileStructV5::StuIndexInfoOfMap;
        memcpy(pItem->pIndex,&pIndexInfoArray[i],sizeof(StuSpaceFileStructV5::StuIndexInfoOfMap));
...
BOOL CSpaceFileDataV5::ReadMap(CFile* pFile,stuMapItem* pMapItem)
{
    StuSpaceFileStructV5 :: StuIndexInfoOfMap* pIndexInfoOfMap = pMapItem->pIndex;
	ASSERT(pIndexInfoOfMap);

	//读入图幅索引
	StuSpaceFileStructV5::StuIndexInfoOfBreadth* pIndexInfoArray = NULL;	//图幅索引数组

	int nCount = pIndexInfoOfMap->nBreadthCount;
	{
		pIndexInfoArray = new StuSpaceFileStructV5::StuIndexInfoOfBreadth[nCount];
		memset(pIndexInfoArray,0,sizeof(StuSpaceFileStructV5::StuIndexInfoOfBreadth)*nCount);
		pFile->Read(pIndexInfoArray,sizeof(StuSpaceFileStructV5::StuIndexInfoOfBreadth) * nCount);
	}
    //////////////////////////////////////////////////////////////////////////
    DWORD dwOffsetBase = pFile->GetPosition();
    //////////////////////////////////////////////////////////////////////////
	...
	for(int i = 0; i < nCount; i++)
	{
        ...
        pItem->pIndex = new StuSpaceFileStructV5::StuIndexInfoOfBreadth;
        memcpy(pItem->pIndex,&pIndexInfoArray[i],sizeof(StuSpaceFileStructV5::StuIndexInfoOfBreadth));
        pItem->pIndex->nID = i;
...
BOOL CSpaceFileDataV5::ReadBreadth(CFile* pFile,stuBreadthItem* pItem)
{
...
//////////////////////////////////////////////////////////////////////////
    StuSpaceFileStructV5 :: StuIndexInfoOfBreadth* pIndex = pItem->pIndex;
	ASSERT(pIndex);
    ASSERTVALID(pIndex);
	...
	{	
		...
		StuSpaceFileStructV5::StuBreadthHeaderInfo* pHeader = (StuSpaceFileStructV5::StuBreadthHeaderInfo*)pBufOfBeforeCompress;
#ifdef ANALYSE_DATA
        {
        ...
        unsigned long nFtrSize = sizeof(StuSpaceFileStructV5::StuGisFeatureRoadSection);
        unsigned long nBuddyOffset = sizeof(StuSpaceFileStructV5::StuBreadthHeaderInfo) + pHeader->nFeatureCount*nFtrSize;
        ...
        StuSpaceFileStructV5::StuGisFeatureRoadSection* pArrayOfStGisFeatureRoadSection = 
            (StuSpaceFileStructV5::StuGisFeatureRoadSection*)(pBufOfBeforeCompress+sizeof(StuSpaceFileStructV5::StuBreadthHeaderInfo));
        
        for(int i = 0; i < pHeader->nFeatureCount; i++)
        {
            CGIS_FeatureRoadSectionV5* pFtr = new CGIS_FeatureRoadSectionV5;
            ASSERT(pFtr);
            memcpy(pFtr->GetDataAddr(),&pArrayOfStGisFeatureRoadSection[i],sizeof(StuSpaceFileStructV5::StuGisFeatureRoadSection));
...
#ifdef ANALYSE_DATA
void CSpaceFileDataV5::CDataAnalyse::Initial()
{
    m_nFtrCount = 0;
    m_nMapCount = 0;
    //关于图幅的
...
void CSpaceFileDataV5::CDataAnalyse::DumpState()
{
...
unsigned long CSpaceFileDataV5::GetFtrCount()
{
